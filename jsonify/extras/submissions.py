    ...
    if response.status_code == 200:
        ...
        if contest_info["status"] == "OK":
            ...
            values = (
                ...
                contest_type # Default contest type
            )
...
def good_verdict(verdict):
    if verdict == "OK" : return "Accepted"
    else : return verdict

# Function to fetch and insert user submissions
def fetch_and_insert_user_submissions(handle, count = 5):
    ...
    if response_status.status_code == 200:
        ...
        for submission in submissions:
            ...
            values = (
                ...
                handle,
                good_verdict(submission.get("verdict", "UNKNOWN")),
...
for handle in user_handles:
    fetch_and_insert_user_submissions(handle, 5)
